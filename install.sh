...
echo -e ""
echo -e "2. Install and launch the background scanning agent service:"
echo -e "   ${BOLD}${GREEN}mailent agent install${NC}"
echo -e ""
echo -e "3. Verify agent status and control plane telemetry:"
echo -e "   ${BOLD}${GREEN}mailent agent status${NC}"
echo -e ""
